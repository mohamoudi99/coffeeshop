...
class Caramel extends StatefulWidget {
  ...
  _CaramelState createState() {
    return _CaramelState();
  }
}
int quantity = Order.cartItems[3].amount;
class _CaramelState extends State<Caramel> {
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              ...
              quantity=Order.cartItems[3].amount;
            ...
            children: [
              Container(
                ...
                child: Center(
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      'lib/images/caramel.jpeg', // Replace with the actual path of your image
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Order.cartItems[3].amount = quantity;
                  Navigator.pushReplacement(
                    context,
                    PageRouteBuilder(
